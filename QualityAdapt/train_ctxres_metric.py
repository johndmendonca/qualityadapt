"""
Training adapter for response evaluation using context.
"""
...
def main():
    ...
    def preprocess_function(examples):
        # Tokenize the texts
        # args=("<s><speaker1> Hi!</s><s> <speaker2> Hi there.</s><s> <speaker1> What's up System??</s>","</s><speaker2> I am chatting with clients on the internet</s>")
    ...
    def preprocess_function_human(examples):
        ...
        result["S"] = np.mean([examples["A1"], examples["A2"], examples["A3"],examples["A4"]],axis=0)
        result["labels"] = result["S"]
